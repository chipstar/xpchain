...
###   xpchaincore.org and xpchain.io and compares them.
...
RCSUBDIR="test"
HOST1="https://xpchaincore.org"
HOST2="https://xpchain.io"
BASEDIR="/bin/"
...
if [ $? -ne 0 ]; then
   echo "xpchain.io failed to provide signature file, but xpchaincore.org did?"
   echo "wget output:"
   echo "$WGETOUT"|sed 's/^/\t/g'
...
if [ "$SIGFILEDIFFS" != "" ]; then
   echo "xpchain.io and xpchaincore.org signature files were not equal?"
