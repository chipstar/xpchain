...
class SegWitTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-whitelist=127.0.0.1", "-vbparams=segwit:0:999999999999", "-addresstype=p2sh-segwit"], ["-whitelist=127.0.0.1", "-acceptnonstdtxn=0", "-vbparams=segwit:0:999999999999", "-addresstype=p2sh-segwit"], ["-whitelist=127.0.0.1", "-vbparams=segwit:0:0", "-addresstype=p2sh-segwit"]]
